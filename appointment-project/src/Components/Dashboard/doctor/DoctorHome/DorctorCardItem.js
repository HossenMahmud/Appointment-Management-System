        ...
        >
            ...
            >
                ...
                <Box>
                    ...
                    <Typography variant='h5' sx={{ color: "#272b41", fontSize: '22px', fontWeight: 'bold' }}>
                        {(value?.patient ? value?.patient : '0')}
                    </Typography>
                    <Typography variant='body' sx={{ color: '#272b41', fontSize: '14px', fontWeight: 'normal' }}>
                        {value?.date}
                    </Typography>
                </Box>
            </Stack>
